...
mod.SPELLS = {
	...
	BLISTERING_COLD = {KEY = "BLISTERING_COLD", NAME = "Blistering Cold", ID = {DEFAULT = 71047, [DBM_BEHAVIOR.DIFFICULTY.NORMAL_10] = 70123}},
	TAILSWEEP = {KEY = "TAILSWEEP", NAME = "Tail Sweep", ID = {DEFAULT = 55696, [DBM_BEHAVIOR.DIFFICULTY.NORMAL_10] = 55697}},
	FROSTBOLT_VOLLEY = {KEY = "FROSTBOLT_VOLLEY", NAME = "Frostbolt Volley", ID = {DEFAULT = 72906, [DBM_BEHAVIOR.DIFFICULTY.NORMAL_10] = 72905}},
}
